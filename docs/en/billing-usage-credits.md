...
- **Failed AI Calls:** Users are *not* charged if an AI parsing call or an AI Deal Brief generation fails. Deductions happen only after a successful AI response saves data.
- **AI Deal Brief:** Generating or regenerating an AI Deal brief consumes credits. Viewing a cached brief does not consume credits.
